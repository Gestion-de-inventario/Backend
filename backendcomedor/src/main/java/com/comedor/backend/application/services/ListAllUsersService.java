...
import com.comedor.backend.application.ports.in.ListAllUsersUseCase;
...
public class ListAllUsersService implements ListAllUsersUseCase {
    ...
    public ListAllUsersService(UserRepositoryPort userRepositoryPort, UserMapper userMapper) {
