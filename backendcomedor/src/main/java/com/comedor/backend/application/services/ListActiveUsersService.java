...
import com.comedor.backend.application.ports.in.ListActiveUsersUseCase;
...
public class ListActiveUsersService implements ListActiveUsersUseCase {
    private final UserRepositoryPort userRepositoryPort;
    private final UserMapper userMapper;

    public ListActiveUsersService(UserRepositoryPort userRepositoryPort, UserMapper userMapper) {
