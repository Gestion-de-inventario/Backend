...
public class ExportarModificacionesPDFService implements ExportarModificacionesPDFUseCase {

    private final ModificationsRepositoryPort repository;
    private final ModificationsMapper mapper;

    public ExportarModificacionesPDFService(ModificationsRepositoryPort repository, ModificationsMapper mapper) {
