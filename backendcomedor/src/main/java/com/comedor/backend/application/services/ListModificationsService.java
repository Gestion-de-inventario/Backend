...
public class ListModificationsService implements ListModificationsUseCase {
    ...
    public ListModificationsService(ModificationsRepositoryPort modificationsRepositoryPort, ModificationsMapper modificationsMapper) {
