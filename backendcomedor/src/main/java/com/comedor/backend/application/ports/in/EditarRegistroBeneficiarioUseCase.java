...
public interface EditarRegistroBeneficiarioUseCase {
    RegistroBeneficiarioResponseDTO editarRegistroBeneficiario(int reporteId,int controlId, ControlBeneficiarioRequestDTO dto);
}
