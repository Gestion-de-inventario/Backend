...
public class ExportarTransaccionesPDFService implements ExportarTransaccionesPDFUseCase {

    private final TransactionRepositoryPort repository;
    private final TransactionMapper mapper;

    public ExportarTransaccionesPDFService(TransactionRepositoryPort repository, TransactionMapper mapper) {
    ...
    public byte[] exportar(LocalDate fechaInicio, LocalDate fechaFin) {
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            for (Transactions t : transacciones) {
                TransaccionResponseDTO dto = mapper.toDTO(t);
