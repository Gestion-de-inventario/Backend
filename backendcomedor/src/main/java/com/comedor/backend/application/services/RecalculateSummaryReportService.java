...
public class RecalculateSummaryReportService
        implements RecalculateSummaryReportUseCase {
    ...
    public RecalculateSummaryReportService(MenuReportRepositoryPort menuReportRepositoryPort, BeneficiaryControlRepositoryPort beneficiaryControlRepositoryPort, ProductRecordRepositoryPort productRecordRepositoryPort) {
